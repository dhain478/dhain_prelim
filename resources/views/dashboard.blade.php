...
<div class="container con pb-2">
  <div class="float-end mt-4">
    <a href="/createpost" class="bg-dark text-white">
      New Post
    </a>
  </div>
  <h1 class="text-light pt-2 pb-2">Recent Post</h1>
  <hr>
  ...
  <div class="card m-1 mb-3 py-3 {{($post->user->gender == 'Male') ? 'male' : 'female'}}">
    <div class="card-body">
      ...
      <p class="card-text bg--primary p-3" style="border-radius: 10px;">{{$post->post}}</p>
    </div>
  </div>
  <style>
     body {
